...
import com.example.simplefoodapp.LoginActivity; // do not copy this import. Use wizard to import this class
...
public class SharedPrefManager {
    ...
    public int getUserId() {
        SharedPreferences sharedPreferences = mCtx.getSharedPreferences(SHARED_PREF_NAME, Context.MODE_PRIVATE);
        return sharedPreferences.getInt(KEY_ID, -1); // -1 is a default value, you can choose a suitable default
    }

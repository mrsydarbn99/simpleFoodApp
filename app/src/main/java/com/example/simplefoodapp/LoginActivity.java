...
import com.example.simplefoodapp.model.ErrorResponse;
import com.example.simplefoodapp.remote.ApiUtils;
import com.example.simplefoodapp.remote.UserService;
...
// the main activity
        if (SharedPrefManager.getInstance(this).isLoggedIn()) {
            ...
            // Check user role and start the corresponding activity
...
// forward user to MainActivity
                        finish();// Check user role and start the corresponding activity
                        if (user.getRole().equals("customer")) {
